"""
migrate_embeddinggemma.py

TEK SEFERLIK migration scripti. Embedding modeli paraphrase-multilingual-
MiniLM-L12-v2'den (384 boyut) google/embeddinggemma-300m'e (768 boyut)
degistirildi (bkz. embedding_servisi.py'deki yorum).

Vektor boyutu DEGISTI ve iki modelin vektor uzaylari zaten kiyaslanamaz
olurdu - bu yuzden HEM "semantic_units" HEM "concept_names" Chroma
koleksiyonlarinin SILINIP YENI modelle YENIDEN olusturulmasi gerekiyor.

Calistirmak icin (proje kok dizininde, venv aktifken, backend KAPALIYKEN):
    python migrate_embeddinggemma.py
"""
